...
class DemoMotionNode(Node):
    def __init__(self):
        ...
        self.create_service(std_srvs.srv.Empty, 'kapandji', self.thumb_kapandji_callback)
    ...
    def thumb_kapandji_callback(self, request, response):
        """
        Demonstrate thumb Kapandji motion, cycling through 10 kapandji positions then home.
        """
        # reset
        self.joint_angle_array.data = [0.0]*16
        self.publisher.publish(self.joint_angle_array)
        ...
        # kapandji 0
        self.joint_angle_array.data[0] = 0.0
        self.joint_angle_array.data[5] = 90.0
        self.joint_angle_array.data[10] = -70.0
        self.joint_angle_array.data[15] = 10.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        # kapandji 1
        self.joint_angle_array.data[0] = -40.0
        self.joint_angle_array.data[5] = 80.0
        self.joint_angle_array.data[10] = -90.0
        self.joint_angle_array.data[15] = 10.0
        self.joint_angle_array.data[6] = 80.0
        self.joint_angle_array.data[1] = 30.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        self.joint_angle_array.data[10] = -60.0
        self.joint_angle_array.data[15] = 0.0
        self.joint_angle_array.data[6] = 90.0
        self.joint_angle_array.data[11] = 50.0
        self.joint_angle_array.data[1] = 10.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        self.joint_angle_array.data[15] = -10.0
        self.joint_angle_array.data[6] = 80.0
        self.joint_angle_array.data[11] = 20.0
        self.joint_angle_array.data[1] = 20.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        # kapandji 4
        self.joint_angle_array.data[0] = 0.0
        self.joint_angle_array.data[5] = 35.0
        self.joint_angle_array.data[10] = -50.0
        self.joint_angle_array.data[15] = -40.0
        self.joint_angle_array.data[7] = 80.0
        self.joint_angle_array.data[12] = 50.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        self.joint_angle_array.data[0] = 40.0
        self.joint_angle_array.data[5] = 10.0
        self.joint_angle_array.data[10] = -55.0
        self.joint_angle_array.data[15] = -45.0
        self.joint_angle_array.data[8] = 80.0
        self.joint_angle_array.data[13] = 60.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        # kapandji 6
        self.joint_angle_array.data[0] = 40.0
        self.joint_angle_array.data[5] = -15.0
        self.joint_angle_array.data[10] = -50.0
        self.joint_angle_array.data[15] = -60.0
        self.joint_angle_array.data[9] = 80.0
        self.joint_angle_array.data[14] = 40.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        # kapandji 7  
        self.joint_angle_array.data[0] = 10.0
        self.joint_angle_array.data[5] = 25.0
        self.joint_angle_array.data[10] = -50.0
        self.joint_angle_array.data[15] = -80.0
        self.joint_angle_array.data[9] = 80.0
        self.joint_angle_array.data[14] = 40.0
        self.joint_angle_array.data[4] = 30.0
        self.publisher.publish(self.joint_angle_array)
        time.sleep(0.5)
        ...
        # kapandji 8 
        self.joint_angle_array.data[0] = 30.0
        self.joint_angle_array.data[5] = 20.0
        self.joint_angle_array.data[10] = -60.0
        self.joint_angle_array.data[15] = -80.0
        self.joint_angle_array.data[9] = 80.0
        self.joint_angle_array.data[14] = 40.0
        ...
        # kapandji 9
        self.joint_angle_array.data[0] = 45.0
        self.joint_angle_array.data[5] = 0.0
        self.joint_angle_array.data[10] = -40.0
        self.joint_angle_array.data[15] = -80.0
        self.publisher.publish(self.joint_angle_array)
        ...
        #  kapandji 10
        self.joint_angle_array.data[0] = 50.0
        self.joint_angle_array.data[5] = -30.0
        self.joint_angle_array.data[15] = -80.0
        self.publisher.publish(self.joint_angle_array)
